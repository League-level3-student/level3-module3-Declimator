...
public class _02_PasswordChecker implements KeyListener {
    ...
    static final String regexCriteria6 = ".{0,16}";
    ...
    static final String CRITERIA5 = "Must not contain spaces";
    static final String CRITERIA6 = "A maximum of 16 characters";
    ...
    public _02_PasswordChecker() {
        ...
        criterias.add(new Criteria(CRITERIA6, regexCriteria6, USE_MATCH));
